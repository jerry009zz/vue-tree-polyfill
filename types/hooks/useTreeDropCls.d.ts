...
declare const prefixCls = "vtree-tree-drop";
...
export declare const useTreeDropCls: (props: TreeDropProps, options: {
    ...
    displayInputCls: import("vue").ComputedRef<(string | {
        "vtree-tree-drop__display-input_focus": boolean;
        "vtree-tree-search__input_disabled": boolean | undefined;
    })[]>;
    displayInputTextCls: import("vue").ComputedRef<(string | {
        "vtree-tree-drop__display-input-placeholder": boolean;
    })[]>;
    dropIconCls: import("vue").ComputedRef<(string | {
        "vtree-tree-drop__display-icon-drop_active": boolean;
    })[]>;
